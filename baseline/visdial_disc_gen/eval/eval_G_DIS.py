...
def eval():
    ...
    while i < len(dataloader_val):
        ...
        for rnd in range(10):
            ...
            if i == 0 and rnd == 0:
                print("ques",question[:,rnd,:])
                print("his",history[:,:rnd+1,:])
                print("tans",opt_answerT[:,rnd,:])
                print("ans",opt_answer[:,rnd,:,:])
                print("gt_id",gt_id)
            ...
            if i == 0 and rnd == 0:
                ...
                print("count",count)
                print("rank_all_tmp",rank_all_tmp)
...
def sample():
    ...
    while i < len(dataloader_val):
        ...
        for rnd in range(10):
            ...
            # print("len(ans_txt)", len(ans_txt))
            for j in range(len(ans_sample_txt)):
                print('Q: %s --A: %s --Sampled: %s' %(ques_txt[j],
                    ans_txt[int(gt_id[j])], ans_sample_txt[j]))
